...
public class Residence {
    ...
    public String toString() {
        StringBuilder sb = new StringBuilder(address_line_1);
        if (address_line_2 != null) {
            sb.append(", ").append(address_line_2);
        }
        sb.append(", ").append(city).append(", ").append(subdivision_name).append(" ").append(zip_code);
        sb.append(", ").append(country_name);
        return sb.toString();
    }
}
